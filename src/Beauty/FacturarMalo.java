 ...
 * @author User
 */
public class FacturarMalo extends javax.swing.JFrame {
    String user = "root";
    String clave = "";
    ...
    public FacturarMalo() {
        ...
        try {
                ...
                Logger.getLogger(FacturarMalo.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButtonListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListoActionPerformed
            ...
            try {
                ...
                stmt.executeUpdate("UPDATE vendido SET cantidad = '5' , nombre = 'mayonesa' WHERE id = '3'");
            } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturarMalo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturarMalo().setVisible(true);
            }
        });
    }
